...
// This is a Server Component that uses builder-css for SSR testing
export default function ServerHeader({
  ...
  return (
    <header className={headerStyles}>
      ...
      <h1 className={titleStyles}>📖 Bookstore Manager</h1>

      <p className={subtitleStyles}>
        Server-Side Rendered with Builder CSS (NextJS Demo Application - App
        Router)
      </p>
